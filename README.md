...
1. Clone the repository:
        ...
        git clone https://github.com/hngx-org/events-be-python.git
...
1. Clone the repo `git clone https://github.com/hngx-org/events-be-python.git`.
2. Open your terminal & set the origin branch: `git remote add origin https://github.com/hngx-org/events-be-python.git`
